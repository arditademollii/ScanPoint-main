...
namespace ScanPoint.Models.Migrations
{
    ...
    [Migration("20260517104844_Prova1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScanPoint.Models.Models.Kursi", b =>
                {
                    b.Property<int>("ID_Kursi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ID_Kursi"));
            ...
            modelBuilder.Entity("ScanPoint.Models.Models.Shkolla", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ID_Shkolla"));
            ...
            modelBuilder.Entity("ScanPoint.Models.Models.Studenti", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EmriStudentit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MbiemriStudentit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ScanPoint.Models.Models.Nxenesi", b =>
                {
                    b.HasOne("ScanPoint.Models.Models.Shkolla", "Shkolla")
                        .WithMany("Nxenesit")
                        .HasForeignKey("ID_Shkolla")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ScanPoint.Models.Models.Studenti", b =>
                {
                    b.HasOne("ScanPoint.Models.Models.Kursi", "Kursi")
                        .WithMany("Studenti")
                        .HasForeignKey("ID_Kursi")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
